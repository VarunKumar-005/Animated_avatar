...
const CharacterStage: React.FC<CharacterStageProps> = ({ character, align, quality, autoRotate }) => {
  ...
  useEffect(() => {
    ...
    scene.add(new THREE.AmbientLight(0xffffff, 2)); // Increased ambient light
